...
//    ----------------------------------------------------------------------------
        ...
        public void execute(int n) {
            switch(n){
                case 1:
                    ...
                    break;
                case 2:
                    controller.deleteIdNhanVien(scanIDNhanVien());
                    break;
                case 3:
    ...
    private Menu menu2 = new Menu("Cap nhat lich cong tac",Sua) {
        ...
        public void execute(int n) {
            switch(n){
                case 1:
                    controller.updateIDNhanVien(scanID(), scanIDNhanVien());
                    break;
                case 2:
                    controller.updateThoiGianBatDau(scanID(), scanNgayBatDau());
                    break;
                case 3:
                    controller.updatePhuongTien(scanID(), scanPhuongTien());
                    break;
                case 4:
...
//    ----------------------------------------------------------------------------
    ...
    private Date scanNgayBatDau(){
        System.out.println("Nhap thoi gian bat dau(YYYY/MM/DD):");
    ...
    private Date scanThoiGianKetThuc(){
        System.out.println("Nhap thoi gian ket thuc(YYYY/MM/DD):");
